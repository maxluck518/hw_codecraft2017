...
6.Note:
 Please note that only the code source file you have modified or added can be submitted in the rematch. The compilation will be performed on the contest question server. Therefore, special attentions must be paid to the following things: 
